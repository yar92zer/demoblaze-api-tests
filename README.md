...
| 5 | `/signup` возвращает пустое тело и при успехе, и при ошибке — результат операции по ответу не определить. | Minor |
| 6 | Мусор в данных каталога: у товара id=9 в названии хвостовой перевод строки; товары id=4, 8, 9 ссылаются на изображения других товаров. | Trivial |
